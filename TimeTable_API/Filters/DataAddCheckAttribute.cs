...
namespace TimeTable_API.Filters
{
    ...
    public class DataAddCheckAttribute : Attribute, IActionFilter
    {
        private readonly LessonContext _DbContext;

        public DataAddCheckAttribute(LessonContext Context)
        {
            _DbContext = Context;
        }
        ...
        public void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            if (lesson == null || lesson.StartTime > lesson.EndTime ||_DbContext.Lessons.Any(l => !l.Check(lesson))) // Проверка
